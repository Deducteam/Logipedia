...
<form role="form" class="center_div" id="form1" method="POST">
    ...
    <textarea class="form-control" required id="proof" name="proof" rows="3" placeholder="Enter Proof"></textarea>
  </div>
                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button" >Next</button>
            </div>
        </div>
...
<form method="POST" action="upload.php?ref=theoremes" enctype="multipart/form-data" class="form-inline center_div2">
...
<?php
  if(isset($_POST['module']) && isset($_POST['id']) && isset($_POST['language']) && isset($_POST['statement']) && isset($_POST['proof']) && isset($_POST['submit'])){
    ...
    $collection -> insertOne(array('langID' => $langID, 'proof' => $_POST['proof'], 'statement' => $_POST['statement'], 'nameID' => $_POST['id'], 'md' => $_POST['module']));
  }
