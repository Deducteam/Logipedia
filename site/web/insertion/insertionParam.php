...
<form method="POST" action="upload.php?ref=parameters" enctype="multipart/form-data" class="form-inline center_div2">
...
<?php
  if(isset($_POST['module']) && isset($_POST['id']) && isset($_POST['language']) && isset($_POST['type']) && isset($_POST['submit'])){
    ...
    $collection -> insertOne(array('langID' => $langID, 'type' => $_POST['type'], 'nameID' => $_POST['id'], 'md' => $_POST['module']));
  }
?>
