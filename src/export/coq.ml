...
let print_bdd ast = function
  | Parameter(name,ty) ->
    insert_parameter (to_string print_name name) (to_string print_ty ty)
  | Definition(name,ty,te) ->
    insert_definition (to_string print_name name) (to_string print_ty ty) (to_string print_te te)
  | Axiom(name,te) ->
    insert_axiom (to_string print_name name) (to_string print_te te)
  | Theorem(name,te,proof) ->
    insert_theorem (to_string print_name name) (to_string print_te te) (to_string print_proof proof)
  | TyOpDef(tyop,arity) ->
    insert_parameter (to_string print_name tyop) (to_string print_arity arity)
