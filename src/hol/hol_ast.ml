...
type ty =
  | TBool                       (* We may not need to have a special case *)
  | TArr of ty * ty             (* We may not need to have a special case *)
  | TDef of name * ty list

type te =
  | Eq of ty                         (* We may not need to have a special case *)
  | Def of name
  | App of te * te list

type item =
  | TyAlias of name * ty
  | TeAlias of name * ty * te
